...
const runSchema = new Schema({
  ...
  description: { type: String, default: "Cuando emprendas tu viaje a Ítaca pide que el camino sea largo, lleno de aventuras, lleno de experiencias." },
  lat: { type: String, default: "46.103208" },
  lon: { type: String, default: "8.411621" },
  password: String,
