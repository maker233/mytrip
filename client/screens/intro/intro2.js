  ...
  render() {
    return (
      <View>
        ...
        <TouchableOpacity style={styles.shareButton} onPress={()=> this.props.navigation.navigate("Intro3")}>
          <Text style={styles.shareButtonText}>NEXT</Text>  
        </TouchableOpacity>
        <TouchableOpacity style={styles.shareButton} onPress={()=> this.props.navigation.navigate("Intro1")}>
